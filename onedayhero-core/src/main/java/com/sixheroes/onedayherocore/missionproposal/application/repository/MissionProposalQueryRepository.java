package com.sixheroes.onedayherocore.missionproposal.application.repository;
...
import com.sixheroes.onedayherocore.missionproposal.domain.MissionProposalStatus;
...
import static com.sixheroes.onedayherocore.missionproposal.domain.QMissionProposal.missionProposal;
...
public class MissionProposalQueryRepository {
    ...
    public Slice<MissionProposalQueryDto> findByHeroIdAndPageable(
        ...
        List<MissionProposalQueryDto> content = jpaQueryFactory.select(Projections.constructor(MissionProposalQueryDto.class,
                ...
                .orderBy(mission.priorityStatus.asc(), missionProposal.createdAt.desc())
