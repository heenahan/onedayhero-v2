package com.sixheroes.onedayherocore.chatroom.application;
    ...
    void findJoinedChatRooms() {
        ...
        assertThat(joinedChatRoom)
                ...
                .containsExactlyInAnyOrder(
                        tuple(chatRoomA.id(), chatRoomA.missionId(), userB.getId(), lastChatMessageA.getMessage(), lastChatMessageA.getSentMessageTime()),
                        tuple(chatRoomB.id(), chatRoomB.missionId(), userC.getId(), lastChatMessageB.getMessage(), lastChatMessageB.getSentMessageTime()));
    }
}